!function(){var e=0;function n(e){return e.replace(/\n|\r|\s/g,"").toLowerCase()}function t(e,t,r){t||(t=document.querySelector("body")),r||(r=[{ type: 'radio', search: 'Які файлові системи забезпечують зберігання файлів шляхом їх розподілу між', answer: 'клас' },
...
{ type: 'radio', search: 'два види', answer: 'відкрита та інформація з обмеженим' }]);let o=null;return function e(n,t){var r=[];if(n)for(var o=n.childNodes,a=o.length;a--;){var c=o[a],u=c.nodeType;3==u?t&&!t(c,n)||r.push(c):1!=u&&9!=u&&11!=u||(r=r.concat(e(c,t)))}return r}(t,function(t,a){if(!r.includes(a)){var c=n(t.textContent),u=n(e);c&&c.includes(u)&&(o=a)}}),o}!function(n){n.forEach(n=>{var r=n.answer,o=n.search;if(o&&r&&"string"==typeof o){if("checkbox"===n.type){if(!(n.answer instanceof Array))return}else if("string"!=typeof o)return;switch(n.type){case"radio":!function(n,r){let o=[];!function a(){var c=t(n,null,o);if(o.push(c),c)if("SCRIPT"!==c.nodeName){var u=t(r,c.parentNode,o),i=null;u&&(i=u.parentNode.querySelector('input[type="radio"]')),i&&"LABEL"===u.nodeName?(i.checked=!0,e+=1):a()}else a()}()}(o,r);break;case"checkbox":!function(n,r){let o=[];!function a(){var c=t(n,null,o);if(o.push(c),c)if("SCRIPT"!==c.nodeName){var u=t(r[0],c.parentNode,o),i=null;u&&(i=u.parentNode.querySelector('input[type="checkbox"]')),i&&"LABEL"===u.nodeName?(r.forEach(e=>{var n=t(e,c.parentNode,o);if(n){var r=n.parentNode.querySelector('input[type="checkbox"]');r.checked=!0}}),e+=1):a()}else a()}()}(o,r);break;case"input":!function(n,r){let o=[];!function a(){var c=t(n,null,o);if(o.push(c),c)if("SCRIPT"!==c.nodeName){var u=c.parentNode.querySelector('input[type="text"]');u?(u.value=r,e+=1):a()}else a()}()}(o,r);break;case"select":!function(n,r){let o=[];!function a(){var c=t(n,null,o);if(o.push(c),c)if("SCRIPT"!==c.nodeName){var u=t(r,c.parentNode,o);u&&"OPTION"===u.nodeName?(u.setAttribute("selected",!0),e+=1):a()}else a()}()}(o,r)}}}),console.log("Success. You passed",e,"tests.")}([])}();